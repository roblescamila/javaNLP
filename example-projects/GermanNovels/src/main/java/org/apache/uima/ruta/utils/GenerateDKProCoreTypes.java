...
package main.java.org.apache.uima.ruta.utils;
...
public class GenerateDKProCoreTypes {
  ...
  public static void main(String[] args) throws ResourceInitializationException, FileNotFoundException, SAXException, IOException {
    TypeSystemDescription typeSystemDescription = org.uimafit.factory.TypeSystemDescriptionFactory.createTypeSystemDescription();
